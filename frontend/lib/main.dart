              ...
              children: [
                Center(
                  child: Container(
                    ...
                    child: const Icon(Icons.lock_person_rounded, size: 36, color: Color(0xFF10B981)),
                  ),
                ),
                ...
                ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : Text('Login', style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white)),
                ),
              ],
            ),
          ),
